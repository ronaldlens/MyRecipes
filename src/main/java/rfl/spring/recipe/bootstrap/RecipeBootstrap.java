...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        // get uoms
        Optional<UnitOfMeasure> teaspoonOptional = unitOfMeasureRepository.findUnitOfMeasureByName("Teaspoon");
        Optional<UnitOfMeasure> tablespoonOptional = unitOfMeasureRepository.findUnitOfMeasureByName("Tablespoon");
        Optional<UnitOfMeasure> dashOptional = unitOfMeasureRepository.findUnitOfMeasureByName("Dash");
        Optional<UnitOfMeasure> pintOptional = unitOfMeasureRepository.findUnitOfMeasureByName("Pint");
        Optional<UnitOfMeasure> cupOptional = unitOfMeasureRepository.findUnitOfMeasureByName("Cup");
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findUnitOfMeasureByName("Each");

        if (!teaspoonOptional.isPresent() || !tablespoonOptional.isPresent() || !dashOptional.isPresent() ||
                !pintOptional.isPresent() || !cupOptional.isPresent() || !eachUomOptional.isPresent()) {
